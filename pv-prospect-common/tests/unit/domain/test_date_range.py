...
def test_split_by_day_multi_day_range() -> None:
...
def test_split_by_day_zero_day_range_returns_empty() -> None:
    dr = DateRange(date(2025, 1, 5), date(2025, 1, 5))
    assert dr.split_by(Period.DAY) == []


def test_split_by_week_exact_monday_to_sunday() -> None:
...
def test_split_by_week_two_full_weeks() -> None:
...
def test_split_by_week_partial_leading_days_excluded() -> None:
...
def test_split_by_week_partial_trailing_days_excluded() -> None:
...
def test_split_by_week_less_than_a_week_returns_empty() -> None:
    dr = DateRange(date(2025, 1, 7), date(2025, 1, 12))
    assert dr.split_by(Period.WEEK) == []


def test_split_by_week_within_single_week_not_starting_monday() -> None:
