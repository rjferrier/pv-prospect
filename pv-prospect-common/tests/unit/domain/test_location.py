...
class TestLocationGetCoordinates:
    ...
    def test_get_coordinates_returns_formatted_string(self) -> None:
    ...
    def test_get_coordinates_with_negative_values(self) -> None:
...
class TestLocationFromFloats:
    ...
    def test_from_floats_creates_location_with_decimal_types(self) -> None:
    ...
    def test_from_floats_rounds_to_four_decimal_places(self) -> None:
