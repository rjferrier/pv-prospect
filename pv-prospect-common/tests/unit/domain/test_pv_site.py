...
def test_panel_geometry_v_norm_zero_tilt_points_straight_up() -> None:
    pg = PanelGeometry(azimuth=0, tilt=0, area_fraction=1.0)
    cx, cy, cz = pg.v_norm
...
def test_pv_site_str_includes_name_and_id() -> None:
    site = PVSite(
        pvo_sys_id=89665,
        name='Test Site',
