...
class RawDataFileMetadata:
    # Pattern: {data_source}_{pv_system_id}_{YYYYMMDD} where pv_system_id and YYYYMMDD are digits
    ...
    def from_filename(cls, filename: str) -> Optional['RawDataFileMetadata']:
        ...
        pv_system_id = int(match.group(2))
    ...
    def replace(
        ...
        return self.__class__(data_source, pv_system_id, date_)
