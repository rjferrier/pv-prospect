...
def upload_file(
    ...
    """
    Upload a file to storage (Google Drive or local directory).
    ...
    if local_dir:
        ...
        print(f"Uploading to local directory: {local_dir}")
    else:
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='Upload a file to storage (Google Drive or local directory)'
    )
    parser.add_argument(
        'source_file',
