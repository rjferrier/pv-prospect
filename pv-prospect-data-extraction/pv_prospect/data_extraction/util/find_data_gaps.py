...
def find_gaps(
    dates: List[datetime], interval_days: int
...
def format_gap_report(
    results: Dict[str, Dict[str, List[Tuple[datetime, datetime, int]]]],
) -> str:
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(
        description='Analyze dataset gaps and generate reports or commands.'
    )
    parser.add_argument(
        '--generate-commands',
        action='store_true',
